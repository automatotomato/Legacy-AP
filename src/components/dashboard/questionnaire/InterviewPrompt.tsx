  ...
  return (
    ...
    >
      ...
      <h2 className="text-2xl font-bold text-gray-900 mb-4">
        Ready for Your {section} Interview
      </h2>

      <p className="text-lg text-gray-600 mb-8">
        Thank you for sharing your memories. Now it's time for your interview where we'll explore 
        these stories in greater detail.
      </p>

      <div className="bg-legacy-50 rounded-lg p-6 mb-8">
        <h3 className="font-semibold text-gray-900 mb-4">Before You Call:</h3>
        <ul className="space-y-3">
          <li className="flex items-center gap-2 text-gray-600">
            <Clock className="w-5 h-5 text-legacy-600" />
            Schedule a quiet hour for the call
          </li>
          <li className="flex items-center gap-2 text-gray-600">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-sm text-gray-500 mt-4">
          After your interview, click below to continue to the next section
        </p>
        <button
          onClick={onContinue}
